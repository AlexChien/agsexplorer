# -*- encoding : utf-8 -*-
set :application, "meishi"
set :server_name, "beta.enjoyoung.cn meishi.koocaa.com"
set :domain,      "112.65.229.47" #ccgexpo
set :repository,  "git@github.com:AlexChien/meishi.git"
set :use_sudo,    false
...
set :keep_releases, 5
set :rvm_ruby_string, '1.9.3@meishi'
set :passenger_ruby, '/home/runner/.rvm/wrappers/ruby-1.9.3-p125/ruby'
set :rvm_type, :user
set :nginx_conf_path, "/usr/local/nginx/conf/vhosts"
