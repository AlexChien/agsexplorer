...
set :server_name, "asset.agsexplorer.com www1.agsexplorer.com www.agsexplorer.com agsexplorer.com *.agsexplorer.com"
set :domain,      "aws" #ey180
set :repository,  "https://github.com/AlexChien/agsexplorer.git"
set :use_sudo,    false
set :deploy_to,   "/home/runner/www/#{application}"
set :scm,         "git"
set :user,        "runner"
set :runner,      "runner"
set :sudo_user,   "runner"
set :rake,        'rake'  #"/opt/ruby-enterprise/bin/rake"
set :keep_releases, 5
set :rvm_ruby_string, '1.9.3@agsexplorer'
set :passenger_ruby, '/home/runner/.rvm/wrappers/ruby-1.9.3-p551/ruby'
set :rvm_type, :user
...
namespace :deploy do
  ...
  after "deploy:finalize_update", :roles => [:web] do
    ...
    run "ln -s #{shared_path}/ags-parser-vin0/output #{current_release}/data"
    migrate
  end
